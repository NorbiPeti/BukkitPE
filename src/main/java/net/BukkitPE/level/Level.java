...
import net.BukkitPE.entity.item.EntityXPOrb;
...
import net.BukkitPE.event.level.*;
import net.BukkitPE.event.player.PlayerInteractEvent;
import net.BukkitPE.event.redstone.RedstoneUpdateEvent;
import net.BukkitPE.event.weather.LightningStrikeEvent;
...
import net.BukkitPE.level.format.generic.EmptyChunkSection;
import net.BukkitPE.level.generator.Generator;
import net.BukkitPE.level.generator.task.*;
import net.BukkitPE.level.particle.DestroyBlockParticle;
import net.BukkitPE.level.particle.Particle;
import net.BukkitPE.level.sound.Sound;
import net.BukkitPE.math.*;
import net.BukkitPE.metadata.BlockMetadataStore;
import net.BukkitPE.metadata.MetadataValue;
import net.BukkitPE.metadata.Metadatable;
import net.BukkitPE.nbt.NBTIO;
import net.BukkitPE.nbt.tag.*;
...
import net.BukkitPE.timings.LevelTimings;
...
/**
 * author: MagicDroidX BukkitPE Project
 */
public class Level implements ChunkManager, Metadatable {
    ...
    public void initLevel() {
        ...
        this.generatorInstance.init(this, new BukkitPERandom(this.getSeed()));
    ...
    public boolean unload(boolean force) {
        ...
        this.server.getLogger().info(this.server.getLanguage().translateString("BukkitPE.level.unloading",
    ...
    public Entity[] getCollidingEntities(AxisAlignedBB bb, Entity entity) {
        ...
        if (entity == null || entity.canCollide()) {
            int minX = BukkitPEMath.floorDouble((bb.minX - 2) / 16);
            int maxX = BukkitPEMath.ceilDouble((bb.maxX + 2) / 16);
            int minZ = BukkitPEMath.floorDouble((bb.minZ - 2) / 16);
            int maxZ = BukkitPEMath.ceilDouble((bb.maxZ + 2) / 16);
    ...
    public boolean unloadChunk(int x, int z, boolean safe, boolean trySave) {
        ...
        try {
            ...
            logger.error(this.server.getLanguage().translateString("BukkitPE.level.chunkUnloadError", e.toString()));
