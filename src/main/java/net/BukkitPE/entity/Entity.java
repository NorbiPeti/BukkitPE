...
import net.BukkitPE.math.Vector2;
...
public abstract class Entity extends Location implements Metadatable {
    ...
    protected boolean checkObstruction(double x, double y, double z) {
        int i = BukkitPEMath.floorDouble(x);
        int j = BukkitPEMath.floorDouble(y);
        int k = BukkitPEMath.floorDouble(z);
    ...
    public boolean isInsideOfWater() {
        ...
        Block block = this.level.getBlock(this.temporalVector.setComponents(BukkitPEMath.floorDouble(this.x), BukkitPEMath.floorDouble(y), BukkitPEMath.floorDouble(this.z)));
    ...
    public boolean isInsideOfSolid() {
        ...
        Block block = this.level.getBlock(
                this.temporalVector.setComponents(
                        BukkitPEMath.floorDouble(this.x),
                        BukkitPEMath.floorDouble(y),
                        BukkitPEMath.floorDouble(this.z))
        );
    ...
    public List<Block> getBlocksAround() {
        if (this.blocksAround == null) {
            int minX = BukkitPEMath.floorDouble(this.boundingBox.minX);
            int minY = BukkitPEMath.floorDouble(this.boundingBox.minY);
            int minZ = BukkitPEMath.floorDouble(this.boundingBox.minZ);
            int maxX = BukkitPEMath.ceilDouble(this.boundingBox.maxX);
            int maxY = BukkitPEMath.ceilDouble(this.boundingBox.maxY);
            int maxZ = BukkitPEMath.ceilDouble(this.boundingBox.maxZ);
